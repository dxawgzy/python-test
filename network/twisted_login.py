...
class IMAPLogic:
    def __init__(self, proto):
        ...
        d = self.proto.login(self.factory.username, self.factory.passeord)
        d.addCallback(self.loggedin)
        d.addCallback(self.stopreactor)
        print "IMAPLogic.__init__ retuning."
...
password = getpass.getpass("Enter password for %s: " % (sys.argv[2], sys.argv[1]))
